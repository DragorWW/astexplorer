...
!function(e){ true?e(__webpack_require__("c9Kp"),__webpack_require__("YUdF"),__webpack_require__("SGYJ"),__webpack_require__("8QMY"),__webpack_require__("KNQx")):"function"==typeof define&&define.amd?define(["../lib/infer","../lib/tern","../lib/comment","acorn/dist/acorn","acorn/dist/walk"],e):void e(tern,tern,tern.comment,acorn,acorn.walk)}(function(e,n,r,t,o){"use strict";function a(e,n){function t(e){r.ensureCommentsBefore(n,e)}o.simple(e,{VariableDeclaration:t,FunctionDeclaration:t,MethodDefinition:t,Property:t,AssignmentExpression:function(e){"="==e.operator&&t(e)},CallExpression:function(e){i(e)&&t(e)},ExportNamedDeclaration:function(e){t(e)},ExportDefaultDeclaration:function(e){t(e)}})}function i(e){return"MemberExpression"==e.callee.type&&"Object"==e.callee.object.name&&"defineProperty"==e.callee.property.name&&e.arguments.length>=3&&"string"==typeof e.arguments[1].value}function c(n,r){A(n.sourceFile.text,r),o.simple(n,{VariableDeclaration:function(e,n){var r=e.declarations[0].id;e.commentsBefore&&"Identifier"==r.type&&f(e,e.commentsBefore,n,n.getProp(e.declarations[0].id.name))},FunctionDeclaration:function(e,n){e.commentsBefore&&f(e,e.commentsBefore,n,n.getProp(e.id.name),e.scope.fnType)},ClassDeclaration:function(e,n){e.commentsBefore&&f(e,e.commentsBefore,n,n.getProp(e.id.name),e.objType)},AssignmentExpression:function(n,r){n.commentsBefore&&f(n,n.commentsBefore,r,e.expressionType({node:n.left,state:r}))},ObjectExpression:function(n,r){for(var t=0;t<n.properties.length;++t){var o=n.properties[t],a=e.propName(o);"<i>"!=a&&o.commentsBefore&&f(o,o.commentsBefore,r,n.objType.getProp(a))}},Class:function(n,r){var t=n.objType.getProp("prototype").getObjType();if(t)for(var o=0;o<n.body.body.length;o++){var a,i=n.body.body[o];i.commentsBefore&&("constructor"==i.kind?f(i,i.commentsBefore,r,n.objType):"<i>"!=(a=e.propName(i))&&f(i,i.commentsBefore,r,t.getProp(a)))}},CallExpression:function(n,r){if(n.commentsBefore&&i(n)){var t=e.expressionType({node:n.arguments[0],state:r}).getObjType();if(t&&t instanceof e.Obj){var o=t.props[n.arguments[1].value];o&&f(n,n.commentsBefore,r,o)}}},ExportNamedDeclaration:function(e,n){e.commentsBefore&&e.declaration&&"FunctionDeclaration"===e.declaration.type&&f(e.declaration,e.commentsBefore,n,n.getProp(e.declaration.id.name),e.declaration.scope.fnType)},ExportDefaultDeclaration:function(e,n){e.commentsBefore&&e.declaration&&"FunctionDeclaration"===e.declaration.type&&f(e.declaration,e.commentsBefore,n,n.getProp(e.declaration.id.name),e.declaration.scope.fnType)}},e.searchVisitor,r)}function l(n){var r=n["!typedef"],t=e.cx(),o=n["!name"];if(r)for(var a in r)t.parent.mod.jsdocTypedefs[a]=g(e.def.parse(r[a],o,a),a)}function s(e){for(var n,r=1;r<e.length;r++){var t=e[r],o=t.match(/^[\s\*]*/)[0];if(o!=t)if(null==n)n=o;else{for(var a=0;a<n.length&&n.charCodeAt(a)==o.charCodeAt(a);)++a;a<n.length&&(n=n.slice(0,a))}}for(e=e.map(function(e,r){if(e=e.replace(/\s+$/,""),0==r&&null!=n)for(var t=0;t<n.length;t++){var o=e.indexOf(n.slice(t));if(0==o)return e.slice(n.length-t)}return null==n||0==r?e.replace(/^[\s\*]*/,""):e.length<n.length?"":e.slice(n.length)});e.length&&!e[e.length-1];)e.pop();for(;e.length&&!e[0];)e.shift();return e}function f(n,r,t,o,a){b(n,t,o,r);var i=e.cx();!a&&o instanceof e.AVal&&o.types.length&&((a=o.types[o.types.length-1])instanceof e.Obj&&a.origin==i.curOrigin&&!a.doc||(a=null));for(var c=r.length-1;c>=0;c--){var l=s(r[c].split(/\r\n?|\n/)).join("\n");if(l){o instanceof e.AVal&&(o.doc=l),a&&(a.doc=l);break}}}function p(e,n){for(;/\s/.test(e.charAt(n));)++n;return n}function u(e){if(!t.isIdentifierStart(e.charCodeAt(0)))return!1;for(var n=1;n<e.length;n++)if(!t.isIdentifierChar(e.charCodeAt(n)))return!1;return!0}function d(e,n,r,t){for(var o=[],a=[],i=!1,c=!0;r=p(n,r),!c||n.charAt(r)!=t;c=!1){var l=n.indexOf(":",r);if(l<0)return null;var s=n.slice(r,l);if(!u(s))return null;o.push(s),r=l+1;var f=y(e,n,r);if(!f)return null;r=f.end,i=i||f.madeUp,a.push(f.type),r=p(n,r);var d=n.charAt(r);if(++r,d==t)break;if(","!=d)return null}return{labels:o,types:a,end:r,madeUp:i}}function m(n,r,t){var o=h(n,r,t);return o?"[]"==r.slice(o.end,o.end+2)?{madeUp:o.madeUp,end:o.end+2,type:new e.Arr(o.type)}:o:null}function y(n,r,t){for(var o,a=!1,i=!1;;){var c=m(n,r,t);if(!c)return null;if(i=i||c.madeUp,a?c.type.propagate(a):o=c.type,t=p(r,c.end),"|"!=r.charAt(t))break;t++,a||(a=new e.AVal,o.propagate(a),o=a)}var l=!1;return"="==r.charAt(t)&&(++t,l=!0),{type:o,end:t,isOptional:l,madeUp:i}}function h(n,r,o){o=p(r,o);var a,i=!1;if(r.indexOf("function(",o)==o){var c=d(n,r,o+9,")"),l=e.ANull;if(!c)return null;if(o=p(r,c.end),":"==r.charAt(o)){++o;var s=y(n,r,o+1);if(!s)return null;o=s.end,l=s.type,i=s.madeUp}a=new e.Fn(null,e.ANull,c.types,c.labels,l)}else if("["==r.charAt(o)){var f=y(n,r,o+1);if(!f)return null;if(o=p(r,f.end),i=f.madeUp,"]"!=r.charAt(o))return null;++o,a=new e.Arr(f.type)}else if("{"==r.charAt(o)){var u=d(n,r,o+1,"}");if(!u)return null;a=new e.Obj(!0);for(var m=0;m<u.types.length;++m){var h=a.defProp(u.labels[m]);h.initializer=!0,u.types[m].propagate(h)}o=u.end,i=u.madeUp}else if("("==r.charAt(o)){var f=y(n,r,o+1);if(!f)return null;if(o=p(r,f.end),")"!=r.charAt(o))return null;++o,a=f.type}else{var v=o;if(!t.isIdentifierStart(r.charCodeAt(o)))return null;for(;t.isIdentifierChar(r.charCodeAt(o));)++o;if(v==o)return null;var b=r.slice(v,o);if(/^(number|integer)$/i.test(b))a=e.cx().num;else if(/^bool(ean)?$/i.test(b))a=e.cx().bool;else if(/^string$/i.test(b))a=e.cx().str;else if(/^(null|undefined)$/i.test(b))a=e.ANull;else if(/^array$/i.test(b)){var f=null;if("."==r.charAt(o)&&"<"==r.charAt(o+1)){var A=y(n,r,o+2);if(!A)return null;if(o=p(r,A.end),i=A.madeUp,">"!=r.charAt(o++))return null;f=A.type}a=new e.Arr(f)}else if(/^object$/i.test(b)){if(a=new e.Obj(!0),"."==r.charAt(o)&&"<"==r.charAt(o+1)){var j=y(n,r,o+2);if(!j)return null;if(o=p(r,j.end),i=i||j.madeUp,","!=r.charAt(o++))return null;var x=y(n,r,o);if(!x)return null;if(o=p(r,x.end),i=j.madeUp||x.madeUp,">"!=r.charAt(o++))return null;x.type.propagate(a.defProp("<i>"))}}else{for(;46==r.charCodeAt(o)||t.isIdentifierChar(r.charCodeAt(o));)++o;var O,P=r.slice(v,o),T=e.cx(),B=T.parent&&T.parent.mod.jsdocTypedefs;B&&P in B?a=B[P]:(O=e.def.parsePath(P,n).getObjType())?a=g(O,P):(T.jsdocPlaceholders||(T.jsdocPlaceholders=Object.create(null)),a=P in T.jsdocPlaceholders?T.jsdocPlaceholders[P]:T.jsdocPlaceholders[P]=new e.Obj(null,P),i=!0)}}return{type:a,end:o,madeUp:i}}function g(n,r){if(n instanceof e.Fn&&/(?:^|\.)[A-Z][^\.]*$/.test(r)){var t=n.getProp("prototype").getObjType();if(t instanceof e.Obj)return e.getInstance(t)}return n}function v(e,n,r){if(r=p(n,r||0),"{"!=n.charAt(r))return null;var t=y(e,n,r+1);if(!t)return null;var o=p(n,t.end);return"}"!=n.charAt(o)?null:(t.end=o+1,t)}function b(e,n,r,t){for(var o,a,i,c,l,s,f=0;f<t.length;++f)for(var p,u=t[f],d=/(?:\n|$|\*)\s*@(type|param|arg(?:ument)?|returns?|this|class|constructor)\s+(.*)/g;p=d.exec(u);)if("class"!=p[1]&&"constructor"!=p[1]){if("this"==p[1]&&(s=y(n,p[2],0)))l=s,c=!0;else if(s=v(n,p[2]))switch(c=!0,p[1]){case"returns":case"return":i=s;break;case"type":o=s;break;case"param":case"arg":case"argument":var m=p[2].slice(s.end).match(/^\s*(\[?)\s*([^\]\s=]+)\s*(?:=[^\]]+\s*)?(\]?).*/);if(!m)continue;var h=m[2]+(s.isOptional||"["===m[1]&&"]"===m[3]?"?":"");(a||(a=Object.create(null)))[h]=s}}else l=c=!0;c&&O(o,l,a,i,e,r)}function A(n,r){for(var t,o=e.cx(),a=/\s@typedef\s+(.*)/g;t=a.exec(n);){var i=v(r,t[1]),c=i&&t[1].slice(i.end).match(/^\s*(\S+)/);if(c&&i.type instanceof e.Obj){for(var l=n.slice(t.index+t[0].length);t=/\s+@prop(?:erty)?\s+(.*)/.exec(l);){var s,f=v(r,t[1]);f&&(s=t[1].slice(f.end).match(/^\s*(\S+)/))&&f.type.propagate(i.type.defProp(s[1])),l=l.slice(t[0].length)}o.parent.mod.jsdocTypedefs[c[1]]=i.type}}}function j(n,r){var t=e.cx().parent.mod.docComment.weight;n.type.propagate(r,t||(n.madeUp?P:void 0))}function x(e){return"FunctionExpression"==e.type||"ArrowFunctionExpression"==e.type}function O(n,r,t,o,a,i){var c;if("VariableDeclaration"==a.type){var l=a.declarations[0];l.init&&x(l.init)&&(c=l.init.scope.fnType)}else"FunctionDeclaration"==a.type?c=a.scope.fnType:"AssignmentExpression"==a.type?x(a.right)&&(c=a.right.scope.fnType):"CallExpression"==a.type||x(a.value)&&(c=a.value.scope.fnType);if(c&&(t||o||r)){if(t)for(var s=0;s<c.argNames.length;++s){var f=c.argNames[s],p=t[f];!p&&(p=t[f+"?"])&&(c.argNames[s]+="?"),p&&j(p,c.args[s])}if(o&&(c.retval==e.ANull&&(c.retval=new e.AVal),j(o,c.retval)),r===!0){var u=c.getProp("prototype").getObjType();r=u&&{type:e.getInstance(u,c)}}r&&j(r,c.self)}else n&&j(n,i)}var P=1;n.registerPlugin("doc_comment",function(e,n){e.mod.jsdocTypedefs=Object.create(null),e.on("reset",function(){e.mod.jsdocTypedefs=Object.create(null)}),e.mod.docComment={weight:n&&n.strong?101:void 0,fullDocs:n&&n.fullDocs},e.on("postParse",a),e.on("postInfer",c),e.on("postLoadDef",l)})});
...
!function(t,e){ true?e(exports,__webpack_require__("8QMY"),__webpack_require__("S/I7"),__webpack_require__("KNQx"),__webpack_require__("2D/b"),__webpack_require__("8XuT")):"function"==typeof define&&define.amd?define(["exports","acorn/dist/acorn","acorn/dist/acorn_loose","acorn/dist/walk","./def","./signal"],e):void e(t.tern||(t.tern={}),acorn,acorn,acorn.walk,tern.def,tern.signal)}(this,function(t,e,r,n,o,i){"use strict";function s(t,e){var r=Object.create(t);if(e)for(var n in e)r[n]=e[n];return r}function p(t,e,r){var n=t.getType(!1),o=e.getType(!1);return!n||!o||a(n,o,r)}function a(t,e,r){if(!t||r>=5)return e;if(!t||t==e)return t;if(!e)return t;if(t.constructor!=e.constructor)return!1;if(t.constructor!=bt){if(t.constructor==vt){var n=0,o=0,i=0;for(var s in t.props)n++,s in e.props&&p(t.props[s],e.props[s],r+1)&&i++;for(var s in e.props)o++;return!(n&&o&&i<Math.max(n,o)/2)&&(n>o?t:e)}return t.constructor==Pt&&(!!(t.args.length==e.args.length&&t.args.every(function(t,n){return p(t,e.args[n],r+1)})&&p(t.retval,e.retval,r+1)&&p(t.self,e.self,r+1))&&t)}var u=t.getProp("<i>").getType(!1);if(!u)return e;var f=e.getProp("<i>").getType(!1);return!f||a(u,f,r+1)?e:void 0}function u(t){for(var e=0,r=0,n=0,o=null,i=0;i<t.length;++i){var s=t[i];if(s instanceof bt)++e;else if(s instanceof Pt)++r;else if(s instanceof vt)++n;else if(s instanceof dt){if(o&&s.name!=o.name)return null;o=s}}if((e&&1)+(r&&1)+(n&&1)+(o&&1)>1)return null;if(o)return o;for(var p=0,a=null,i=0;i<t.length;++i){var s=t[i],u=0;if(e)u=s.getProp("<i>").isEmpty()?1:2;else if(r){u=1;for(var f=0;f<s.args.length;++f)s.args[f].isEmpty()||++u;s.retval.isEmpty()||++u}else n&&(u=s.name?100:2);u>=p&&(p=u,a=s)}return a}function f(t,e){Tt.disabledComputing={fn:t,prev:Tt.disabledComputing};var r=e();return Tt.disabledComputing=Tt.disabledComputing.prev,r}function c(t){var e=t.charCodeAt(0);return e>=48&&e<=57&&!/\D/.test(t)}function l(t){return"__proto__"==t||"✖"==t||mt&&"__iterator__"==t}function h(t,e){(Tt.props[t]||(Tt.props[t]=[])).push(e)}function g(t){return Tt.props[t]}function y(e){if(Tt.workList)return e(Tt.workList);for(var r=[],n=0,o=Tt.workList=function(t,e,o){n<Et-St*r.length&&r.push(t,e,o,n)},i=e(o),s=0;s<r.length;s+=4){if(xt&&+new Date>=xt)throw new t.TimedOut;n=r[s+3]+1,r[s+1].addType(r[s],r[s+2])}return Tt.workList=null,i}function d(t,e,r){var n=Tt.curSuperCtor,o=Tt.curSuper;Tt.curSuperCtor=t,Tt.curSuper=e;var i=r();return Tt.curSuperCtor=n,Tt.curSuper=o,i}function v(t,e){for(;t.isBlock||t.isCatch||e===!1&&t.fnType&&t.fnType.isArrowFn();)t=t.prev;return t}function m(t,e){var r=v(t).fnType;r&&(r.instantiateScore=(r.instantiateScore||0)+e)}function P(t,e){try{return n.simple(t,{Expression:function(){if(--e<=0)throw Ot}}),!0}catch(t){if(t==Ot)return!1;throw t}}function b(t,e){var r=e.instantiateScore;if(!Tt.disabledComputing&&r&&e.args.length&&P(t,5*r))return m(v(e.originNode.scope.prev),r/2),w(t,e),!0;e.instantiateScore=null}function w(t,e){for(var r=0;r<e.args.length;++r)e.args[r]=new X;e.self=new X,e.computeRet=function(r,o){return f(e,function(){var i=Tt.curOrigin;Tt.curOrigin=e.origin;var s=t.scope,p=new Nt(s.prev,s.originNode);for(var a in s.props)for(var u=p.defProp(a,s.props[a].originNode),f=0;f<o.length;++f)e.argNames[f]==a&&f<o.length&&o[f].propagate(u);for(var c=e.argNames.length!=o.length?e.argNames.slice(0,o.length):e.argNames;c.length<o.length;)c.push("?");if(p.fnType=new Pt(e.name,r,o,c,K,e.generator),p.fnType.originNode=e.originNode,e.arguments){var l=p.fnType.arguments=new X;p.defProp("arguments").addType(new bt(l));for(var f=0;f<o.length;++f)o[f].propagate(l)}return t.scope=p,n.recursive(t.body,p,null,jt),n.recursive(t.body,p,null,kt),Tt.curOrigin=i,p.fnType.retval})}}function T(t){function e(t,n,o){if(!(o>3)&&t.forward)for(var i=0;i<t.forward.length;++i){var s=t.forward[i].propagatesTo();if(s){var p,a=n;if(s instanceof X)p=s;else{if(!(s.target instanceof X))continue;a+=s.pathExt,p=s.target}if(p==r)return a;var u=e(p,a,o+1);if(u)return u}}}var r=t.retval;if(r!=K&&!t.isArrowFn()){var n,i;!r.isEmpty()&&(n=r.getType())instanceof bt&&(r=i=n.getProp("<i>"));for(var s=e(t.self,"!this",0),p=0;!s&&p<t.args.length;++p)s=e(t.args[p],"!"+p,0);if(s){i&&(s="["+s+"]");var a=new o.TypeParser(s),u=a.parseType(!0);return t.computeRet=u.apply?u:function(){return u},t.computeRetSource=s,!0}}}function x(t,e){return t.defProp(e.name,e)}function E(t){return"Identifier"==t.type?t.name:"AssignmentPattern"==t.type?E(t.left):"ObjectPattern"==t.type?"{"+t.properties.map(function(t){return E(t.value)}).join(", ")+"}":"ArrayPattern"==t.type?"["+t.elements.map(function(t){return t?E(t):""}).join(", ")+"]":"RestElement"==t.type?"..."+E(t.argument):"_"}function S(t){return"VariableDeclaration"==t.type&&"var"!=t.kind||"FunctionDeclaration"==t.type||"ClassDeclaration"==t.type}function N(t,e){return{inner:t,outer:e||t}}function O(t){var e=t.getSymbolType();if(e)return e.asPropName()}function j(t){switch(t){case"+":case"-":case"~":return Tt.num;case"!":return Tt.bool;case"typeof":return Tt.str;case"void":case"delete":return K}}function C(t){switch(t){case"==":case"!=":case"===":case"!==":case"<":case">":case">=":case"<=":case"in":case"instanceof":return!0}}function A(t){if(t.regex)return pt(Tt.protos.RegExp);switch(typeof t.value){case"boolean":return Tt.bool;case"number":return Tt.num;case"string":return Tt.str;case"object":case"function":return t.value?pt(Tt.protos.RegExp):K}}function F(t,e){if(t==e||e==K)return t;if(t==K)return e;var r=new X;return t.propagate(r),e.propagate(r),r}function k(t,e){for(var r=0;r<t.params.length;r++){var n=t.params[r];"Identifier"!=n.type&&H(n,e,t.scope.fnType.args[r])}}function I(t,e){return e.hasProp(t.name)||Tt.topScope.defProp(t.name,t)}function H(t,e,r){var n=At[t.type];n&&n(t,e,r)}function D(t){var e=v(t);return e.fnType?e.fnType.self:e}function M(t){t.isEmpty()&&t.propertyOf&&(t.propertyOf.getProp(t.propertyName).addType(new vt,Q),M(t.propertyOf))}function R(t,e,r){!r&&t.id&&(r=t.id.name);var n,o,i=Tt.protos.Object;if(t.superClass)if("Literal"==t.superClass.type&&null==t.superClass.value)i=null;else{var s,p=V(t.superClass,e);n=p.getFunctionType(),n&&(s=n.getProp("prototype").getObjType())?i=s:(n=p,o=p.getProp("prototype"))}var a=new vt(i,r&&r+".prototype");return o&&o.propagate(new ht(a)),d(n,o||i,function(){for(var n,o=t.body.body,i=0;i<o.length;i++)"constructor"==o[i].kind&&(n=o[i].value);var s=t.objType=n?V(n,e):new Pt(r,K,[],null,K);s.originNode=t.id||n||t;var p=pt(a,s);s.self.addType(p),s.defProp("prototype",t).addType(a);for(var i=0;i<o.length;i++){var u,f=o[i];if("constructor"!=f.kind){var c=Ct(f,e);"<i>"==c||"set"==f.kind?u=K:(u=(f.static?s:a).defProp(c,f.key),u.initializer=!0,"get"==f.kind&&(u=new ot(p,[],null,u))),V(f.value,e,u);var l=u.getFunctionType();l&&l.self.addType(p)}}return s})}function _(t,e,r){var n=t.length>1&&t.length<6;if(n){for(var o,i=!0,s=0;s<t.length;s++){var p=t[s];p?"Literal"!=p.type||o&&o!=typeof p.value?i=!1:o=typeof p.value:n=!1}i&&(n=!1)}if(n){for(var a=[],s=0;s<t.length;++s)a.push(r(t[s],e));return new bt(a)}if(t.length<2)return new bt(t[0]&&r(t[0],e));for(var u=new X,s=0;s<t.length;s++)t[s]&&r(t[s],e).propagate(u);return new bt(u)}function L(t){return function(e,r,n,o){var i=t(e,r,o);return n&&i.propagate(n),i}}function q(t){return function(e,r,n,o){return n||(n=new X),t(e,r,n,o),n}}function V(t,e,r,n){var o=Ft[t.type];return o?o(t,e,r,n):K}function G(t){return"VariableDeclaration"==t.type?t.declarations[0].id:t}function B(t,e,r){var n=Array.isArray(t);return n&&1==t.length&&(t=t[0],n=!1),n?null==r?function(e){return t.indexOf(e.origin)>-1}:function(n,o){return o&&o.start>=e&&o.end<=r&&t.indexOf(n.origin)>-1}:null==r?function(e){return e.origin==t}:function(n,o){return o&&o.start>=e&&o.end<=r&&n.origin==t}}function U(t){Rt=!0;var e=g(t);if(e)for(var r=0;r<e.length;++r){var n=e[r].getProp(t);if(!n.isEmpty())return n}return K}function z(t,e){var r=new vt(!0);r.defProp("done").addType(Tt.bool),e.propagate(r.defProp("value"));var n=new Pt(null,K,t?[t]:[],t?["?"]:[],r),o=new vt(Tt.definitions.ecmascript&&Tt.definitions.ecmascript.generator_prototype||!0);return o.defProp("next").addType(n),o}function W(t,e){return t.generator?t.computeRet?z(t.yieldval,e):(t.generator===!0&&(t.generator=z(t.yieldval,e)),t.generator):e}function $(t,e,r){var n=Y(t,r).getFunctionType();if(!n)return K;var o=n.retval;if(n.computeRet){for(var i=0,s=[];i<e.length;++i)s.push(Y(e[i],r));var p=K;"MemberExpression"==t.type&&(p=Y(t.object,r)),o=n.computeRet(p,s,e)}return W(n,o)}function Y(t,e){var r=Ht[t.type];return r?r(t,e):K}var J=t.toString=function(t,e,r){return!t||t==r||e&&e<-3?"?":t.toString(e,r)},K=t.ANull=i.mixin({addType:function(){},propagate:function(){},getProp:function(){return K},forAllProps:function(){},hasType:function(){return!1},isEmpty:function(){return!0},getFunctionType:function(){},getObjType:function(){},getSymbolType:function(){},getType:function(){},gatherProperties:function(){},propagatesTo:function(){},typeHint:function(){},propHint:function(){},toString:function(){return"?"}}),Q=1,X=t.AVal=function(){this.types=[],this.forward=null,this.maxWeight=0};X.prototype=s(K,{addType:function(t,e){if(e=e||100,this.maxWeight<e){if(this.maxWeight=e,1==this.types.length&&this.types[0]==t)return;this.types.length=0}else if(this.maxWeight>e||this.types.indexOf(t)>-1)return;this.signal("addType",t),this.types.push(t);var r=this.forward;r&&y(function(n){for(var o=0;o<r.length;++o)n(t,r[o],e)})},propagate:function(t,e){if(!(t==K||t instanceof yt&&this.forward&&this.forward.length>2)){e&&100!=e&&(t=new gt(t,e)),(this.forward||(this.forward=[])).push(t);var r=this.types;r.length&&y(function(n){for(var o=0;o<r.length;++o)n(r[o],t,e)})}},getProp:function(t){if(l(t))return K;var e=(this.props||(this.props=Object.create(null)))[t];return e||(e=this.props[t]=new X,this.propagate(new et(t,e))),e},forAllProps:function(t){this.propagate(new nt(t))},hasType:function(t){return this.types.indexOf(t)>-1},isEmpty:function(){return 0===this.types.length},getFunctionType:function(){for(var t=this.types.length-1;t>=0;--t)if(this.types[t]instanceof Pt)return this.types[t]},getObjType:function(){for(var t=null,e=this.types.length-1;e>=0;--e){var r=this.types[e];if(r instanceof vt){if(r.name)return r;t||(t=r)}}return t},getSymbolType:function(){for(var t=this.types.length-1;t>=0;--t)if(this.types[t]instanceof wt)return this.types[t]},getType:function(t){return 0===this.types.length&&t!==!1?this.makeupType():1===this.types.length?this.types[0]:u(this.types)},toString:function(t,e){if(0==this.types.length)return J(this.makeupType(),t,e);if(1==this.types.length)return J(this.types[0],t,e);var r=Z(this.types);return r.length>2?"?":r.map(function(r){return J(r,t,e)}).join("|")},makeupPropType:function(t){var e=this.propertyName,r=t.proto&&t.proto.hasProp(e);if(r){var n=r.getType();if(n)return n}if("<i>"!=e){var o=t.hasProp("<i>");if(o)return o.getType()}else if(t.props["<i>"]!=this)for(var i in t.props){var s=t.props[i];if(!s.isEmpty())return s.getType()}},makeupType:function(){var t=this.propertyOf&&this.makeupPropType(this.propertyOf);if(t)return t;if(!this.forward)return null;for(var e=this.forward.length-1;e>=0;--e){var r=this.forward[e].typeHint();if(r&&!r.isEmpty())return Rt=!0,r}for(var n=Object.create(null),o=null,e=0;e<this.forward.length;++e){var i=this.forward[e].propHint();i&&"length"!=i&&"<i>"!=i&&"✖"!=i&&i!=Tt.completingProperty&&(n[i]=!0,o=i)}if(!o)return null;var s=g(o);if(s){var p=[];t:for(var e=0;e<s.length;++e){var a=s[e];for(var i in n)if(!a.hasProp(i))continue t;a.hasCtor&&(a=pt(a)),p.push(a)}var f=u(p);if(f)return Rt=!0,f}},typeHint:function(){return this.types.length?this.getType():null},propagatesTo:function(){return this},gatherProperties:function(t,e){for(var r=0;r<this.types.length;++r)this.types[r].gatherProperties(t,e)},guessProperties:function(t){if(this.forward)for(var e=0;e<this.forward.length;++e){var r=this.forward[e].propHint();r&&t(r,null,0)}var n=this.makeupType();n&&n.gatherProperties(t)}});var Z=t.simplifyTypes=function(t){var e=[];t:for(var r=0;r<t.length;++r){for(var n=t[r],o=0;o<e.length;o++){var i=a(n,e[o],0);if(i){e[o]=i;continue t}}e.push(n)}return e},tt=t.constraint=function(t){var e=function(){this.origin=Tt.curOrigin,this.construct.apply(this,arguments)};e.prototype=Object.create(K);for(var r in t)t.hasOwnProperty(r)&&(e.prototype[r]=t[r]);return e},et=tt({construct:function(t,e){this.prop=t,this.target=e},addType:function(t,e){t.getProp&&t.getProp(this.prop).propagate(this.target,e)},propHint:function(){return this.prop},propagatesTo:function(){if("<i>"==this.prop||!/[^\w_]/.test(this.prop))return{target:this.target,pathExt:"."+this.prop}}}),rt=t.PropHasSubset=t.DefProp=tt({construct:function(t,e,r){this.prop=t,this.type=e,this.originNode=r},addType:function(t,e){if(t instanceof vt){var r=t.defProp(this.prop,this.originNode);r.origin||(r.origin=this.origin),this.type.propagate(r,e)}},propHint:function(){return this.prop}}),nt=tt({construct:function(t){this.c=t},addType:function(t){t instanceof vt&&t.forAllProps(this.c)}}),ot=t.IsCallee=tt({construct:function(t,e,r,n){this.self=t,this.args=e,this.argNodes=r,this.retval=n,this.disabled=Tt.disabledComputing},addType:function(t,e){if(t instanceof Pt){for(var r=0;r<this.args.length;++r)r<t.args.length&&this.args[r].propagate(t.args[r],e),t.arguments&&this.args[r].propagate(t.arguments,e);t.isArrowFn()||this.self.propagate(t.self,this.self==Tt.topScope?90:e);var n=t.computeRet,o=t.retval;if(n)for(var i=this.disabled;i;i=i.prev)(i.fn==t||t.originNode&&i.fn.originNode==t.originNode)&&(n=null);if(n){var s=Tt.disabledComputing;Tt.disabledComputing=this.disabled,o=n(this.self,this.args,this.argNodes),Tt.disabledComputing=s}W(t,o).propagate(this.retval,e)}},typeHint:function(){for(var t=[],e=0;e<this.args.length;++e)t.push("?");return new Pt(null,this.self,this.args,t,K)},propagatesTo:function(){return{target:this.retval,pathExt:".!ret"}}}),it=tt({construct:function(t,e,r,n){this.propName=t,this.args=e,this.argNodes=r,this.retval=n,this.disabled=Tt.disabledComputing},addType:function(t,e){var r=new ot(t,this.args,this.argNodes,this.retval);r.disabled=this.disabled,t.getProp(this.propName).propagate(r,e)},propHint:function(){return this.propName}}),st=t.IsCtor=tt({construct:function(t,e){this.target=t,this.noReuse=e},addType:function(t,e){t instanceof Pt&&(Tt.parent&&!Tt.parent.options.reuseInstances&&(this.noReuse=!0),t.getProp("prototype").propagate(new at(!this.noReuse&&t,this.target),e))}}),pt=t.getInstance=function(t,e){if(e===!1)return new vt(t);e||(e=t.hasCtor),t.instances||(t.instances=[]);for(var r=0;r<t.instances.length;++r){var n=t.instances[r];if(n.ctor==e)return n.instance}var o=new vt(t,e&&e.name);return o.origin=t.origin,t.instances.push({ctor:e,instance:o}),o},at=t.IsProto=tt({construct:function(t,e){this.ctor=t,this.target=e},addType:function(t,e){t instanceof vt&&((this.count=(this.count||0)+1)>8||(t==Tt.protos.Array?this.target.addType(new bt):this.target.addType(pt(t,this.ctor))))}}),ut=tt({construct:function(t){this.fn=t},addType:function(t,e){if(t instanceof vt&&!t.hasCtor){t.hasCtor=this.fn;var r=new lt(t,this.fn);r.addType(this.fn),t.forAllProps(function(t,e,n){n&&e.propagate(r)})}}}),ft=tt({construct:function(t,e){this.other=t,this.target=e},addType:function(t,e){t==Tt.str?this.target.addType(Tt.str,e):t==Tt.num&&this.other.hasType(Tt.num)&&this.target.addType(Tt.num,e)},typeHint:function(){return this.other}}),ct=t.IfObj=tt({construct:function(t){this.target=t},addType:function(t,e){t instanceof vt&&this.target.addType(t,e)},propagatesTo:function(){return this.target}}),lt=tt({construct:function(t,e){this.obj=t,this.ctor=e},addType:function(t){t instanceof Pt&&t.self&&t.self.addType(pt(this.obj,this.ctor),4)}}),ht=tt({construct:function(t){this.obj=t},addType:function(t){t instanceof vt&&this.obj.proto==Tt.protos.Object&&this.obj.replaceProto(t)}}),gt=tt({construct:function(t,e){this.inner=t,this.weight=e},addType:function(t,e){this.inner.addType(t,Math.min(e,this.weight))},propagatesTo:function(){return this.inner.propagatesTo()},typeHint:function(){return this.inner.typeHint()},propHint:function(){return this.inner.propHint()}}),yt=t.Type=function(){};yt.prototype=s(K,{constructor:yt,propagate:function(t,e){t.addType(this,e)},hasType:function(t){return t==this},isEmpty:function(){return!1},typeHint:function(){return this},getType:function(){return this}});var dt=t.Prim=function(t,e){this.name=e,this.proto=t};dt.prototype=s(yt.prototype,{constructor:dt,toString:function(){return this.name},getProp:function(t){return this.proto.hasProp(t)||K},gatherProperties:function(t,e){this.proto&&this.proto.gatherProperties(t,e)}});var vt=t.Obj=function(t,e){if(this.props||(this.props=Object.create(null)),this.proto=t===!0?Tt.protos.Object:t,t&&t!=Tt.protos.Object&&!e&&t.name&&!(this instanceof Pt)){var r=/^(.*)\.prototype$/.exec(this.proto.name);r&&(e=r[1])}this.name=e,this.maybeProps=null,this.origin=Tt.curOrigin};vt.prototype=s(yt.prototype,{constructor:vt,toString:function(t){if(null==t&&(t=0),t<=0&&this.name)return this.name;var e=[],r=!1;for(var n in this.props)if("<i>"!=n){if(e.length>5){r=!0;break}t?e.push(n+": "+J(this.props[n],t-1,this)):e.push(n)}return e.sort(),r&&e.push("..."),"{"+e.join(", ")+"}"},hasProp:function(t,e){c(t)&&(t=this.normalizeIntegerProp(t));var r=this.props[t];if(e!==!1)for(var n=this.proto;n&&!r;n=n.proto)r=n.props[t];return r},defProp:function(t,e){var r=this.hasProp(t,!1);if(r)return e&&!r.originNode&&(r.originNode=e),r;if(l(t))return K;c(t)&&(t=this.normalizeIntegerProp(t));var n=this.maybeProps&&this.maybeProps[t];return n?(delete this.maybeProps[t],this.maybeUnregProtoPropHandler()):(n=new X,n.propertyOf=this,n.propertyName=t),this.props[t]=n,n.originNode=e,n.origin=Tt.curOrigin,this.broadcastProp(t,n,!0),n},getProp:function(t){var e=this.hasProp(t,!0)||this.maybeProps&&this.maybeProps[t];if(e)return e;if(l(t))return K;c(t)&&(t=this.normalizeIntegerProp(t));var r=this.ensureMaybeProps()[t]=new X;return r.propertyOf=this,r.propertyName=t,r},normalizeIntegerProp:function(t){return"<i>"},broadcastProp:function(t,e,r){if(r&&(this.signal("addProp",t,e),this instanceof Nt||h(t,this)),this.onNewProp)for(var n=0;n<this.onNewProp.length;++n){var o=this.onNewProp[n];o.onProtoProp?o.onProtoProp(t,e,r):o(t,e,r)}},onProtoProp:function(t,e,r){var n=this.maybeProps&&this.maybeProps[t];n&&(delete this.maybeProps[t],this.maybeUnregProtoPropHandler(),this.proto.getProp(t).propagate(n)),this.broadcastProp(t,e,!1)},replaceProto:function(t){this.proto&&this.maybeProps&&this.proto.unregPropHandler(this),this.proto=t,this.maybeProps&&this.proto.forAllProps(this)},ensureMaybeProps:function(){return this.maybeProps||(this.proto&&this.proto.forAllProps(this),this.maybeProps=Object.create(null)),this.maybeProps},removeProp:function(t){var e=this.props[t];delete this.props[t],this.ensureMaybeProps()[t]=e,e.types.length=0},forAllProps:function(t){this.onNewProp||(this.onNewProp=[],this.proto&&this.proto.forAllProps(this)),this.onNewProp.push(t);for(var e=this;e;e=e.proto)for(var r in e.props)t.onProtoProp?t.onProtoProp(r,e.props[r],e==this):t(r,e.props[r],e==this)},maybeUnregProtoPropHandler:function(){if(this.maybeProps){for(var t in this.maybeProps)return;this.maybeProps=null}!this.proto||this.onNewProp&&this.onNewProp.length||this.proto.unregPropHandler(this)},unregPropHandler:function(t){for(var e=0;e<this.onNewProp.length;++e)if(this.onNewProp[e]==t){this.onNewProp.splice(e,1);break}this.maybeUnregProtoPropHandler()},gatherProperties:function(t,e){for(var r in this.props)"<i>"!=r&&":"!=r.charAt(0)&&t(r,this,e);this.proto&&this.proto.gatherProperties(t,e+1)},getObjType:function(){return this}});var mt="undefined"!=typeof StopIteration,Pt=t.Fn=function(t,e,r,n,o,i){vt.call(this,Tt.protos.Function,t),this.self=e,this.args=r,this.argNames=n,this.retval=o,this.generator=i};Pt.prototype=s(vt.prototype,{constructor:Pt,toString:function(t){null==t&&(t=0);for(var e=this.generator?"fn*(":"fn(",r=0;r<this.args.length;++r){r&&(e+=", ");var n=this.argNames[r];n&&"?"!=n&&(e+=n+": "),e+=t>-3?J(this.args[r],t-1,this):"?"}return e+=")",this.retval.isEmpty()||(e+=" -> "+(t>-3?J(this.retval,t-1,this):"?")),e},getProp:function(t){if("prototype"==t){var e=this.hasProp(t,!1);if(!e){e=this.defProp(t);var r=new vt(!0,this.name&&this.name+".prototype");r.origin=this.origin,e.addType(r,10)}return e}return vt.prototype.getProp.call(this,t)},defProp:function(t,e){if("prototype"==t){var r=this.hasProp(t,!1);return r?r:(r=vt.prototype.defProp.call(this,t,e),r.origin=this.origin,r.propagate(new ut(this)),r)}return vt.prototype.defProp.call(this,t,e)},getFunctionType:function(){return this},isArrowFn:function(){return this.originNode&&"ArrowFunctionExpression"==this.originNode.type}});var bt=t.Arr=function(t){vt.call(this,Tt.protos.Array);var e=this.defProp("<i>");if(Array.isArray(t)){this.tuple=t.length;for(var r=0;r<t.length;r++){var n=this.defProp(String(r));t[r].propagate(n),n.propagate(e)}}else t&&(this.tuple=0,t.propagate(e))};bt.prototype=s(vt.prototype,{constructor:bt,toString:function(t){if(null==t&&(t=0),t<=-3)return"[?]";var e="";if(this.tuple){for(var r,n=0;n in this.props;n++){var o=J(this.getProp(String(n)),t-1,this);r=null==r?o:r==o&&o,e+=(e?", ":"")+o}r&&(e=r)}else e=J(this.getProp("<i>"),t-1,this);return"["+e+"]"},normalizeIntegerProp:function(t){return+t<this.tuple?t:"<i>"}});var wt=t.Sym=function(t,e){dt.call(this,Tt.protos.Symbol,"Symbol"),this.symName=t,this.originNode=e};wt.prototype=s(dt.prototype,{constructor:wt,asPropName:function(){return":"+this.symName},getSymbolType:function(){return this}}),t.getSymbol=function(t,e){var r=t.replace(/[^\w$\.]/g,"_"),n=Tt.symbols[r];return n?(e&&!n.originNode&&(n.originNode=e),n):Tt.symbols[r]=new wt(r,e)},t.Context=function(e,r){this.parent=r,this.props=Object.create(null),this.protos=Object.create(null),this.origins=[],this.curOrigin="ecmascript",this.paths=Object.create(null),this.definitions=Object.create(null),this.purgeGen=0,this.workList=null,this.disabledComputing=null,this.curSuperCtor=this.curSuper=null,this.symbols=Object.create(null),t.withContext(this,function(){if(Tt.protos.Object=new vt(null,"Object.prototype"),Tt.topScope=new Nt,Tt.topScope.name="<top>",Tt.protos.Array=new vt(!0,"Array.prototype"),Tt.protos.Function=new Pt("Function.prototype",K,[],[],K),Tt.protos.Function.proto=Tt.protos.Object,Tt.protos.RegExp=new vt(!0,"RegExp.prototype"),Tt.protos.String=new vt(!0,"String.prototype"),Tt.protos.Number=new vt(!0,"Number.prototype"),Tt.protos.Boolean=new vt(!0,"Boolean.prototype"),Tt.protos.Symbol=new vt(!0,"Symbol.prototype"),Tt.str=new dt(Tt.protos.String,"string"),Tt.bool=new dt(Tt.protos.Boolean,"bool"),Tt.num=new dt(Tt.protos.Number,"number"),Tt.curOrigin=null,e)for(var t=0;t<e.length;++t)o.load(e[t])})},t.Context.prototype.startAnalysis=function(){this.disabledComputing=this.workList=this.curSuperCtor=this.curSuper=null};var Tt=null;t.cx=function(){return Tt},t.withContext=function(t,e){var r=Tt;Tt=t;try{return e()}finally{Tt=r}},t.TimedOut=function(){this.message="Timed out",this.stack=(new Error).stack},t.TimedOut.prototype=Object.create(Error.prototype),t.TimedOut.prototype.name="infer.TimedOut";var xt;t.withTimeout=function(t,e){var r=+new Date+t,n=xt;if(n&&n<r)return e();xt=r;try{return e()}finally{xt=n}},t.addOrigin=function(t){Tt.origins.indexOf(t)<0&&Tt.origins.push(t)};var Et=20,St=1e-4,Nt=t.Scope=function(t,e,r,n){vt.call(this,t||!0),this.prev=t,this.originNode=e,this.isBlock=!!r,this.isCatch=!!n};Nt.prototype=s(vt.prototype,{constructor:Nt,defVar:function(t,e){for(var r=this;;r=r.proto){var n=r.props[t];if(n)return n;if(!r.prev)return r.defProp(t,e)}}});var Ot={},jt=t.scopeGatherer=n.make({VariablePattern:function(t,e){e.inner&&x(e.inner,t)},AssignmentPattern:function(t,e,r){r(t.left,e,"Pattern"),r(t.right,e.outer,"Expression")},AssignmentExpression:function(t,e,r){"MemberExpression"==t.left.type?r(t.left,e,"Expression"):r(t.left,N(!1,e),"Pattern"),r(t.right,e,"Expression")},MemberPattern:function(t,e,r){r(t,e.outer)},Function:function(t,e,r){for(var n=t.scope=new Nt(e,t),o=[],i=[],s=0;s<t.params.length;++s){var p=t.params[s];if(i.push(E(p)),"Identifier"==p.type)o.push(x(n,p));else{var a=new X;o.push(a),a.originNode=p,r(p,N(n),"Pattern")}}if(n.fnType=new Pt(t.id&&t.id.name,new X,o,i,K,t.generator),n.fnType.originNode=t,t.id){x("FunctionDeclaration"==t.type?e:n,t.id)}r(t.body,n,t.expression?"Expression":"Statement")},BlockStatement:function(t,e,r){!t.scope&&t.body.some(S)&&(e=t.scope=new Nt(e,t,!0)),n.base.BlockStatement(t,e,r)},CatchClause:function(t,e,r){if(e=t.scope=new Nt(e,t,!1,!0),"Identifier"==t.param.type){var n=x(e,t.param);r(t.body,e,"Statement");var o=Tt.definitions.ecmascript;o&&n.isEmpty()&&pt(o["Error.prototype"]).propagate(n,6)}else r(t.param,N(e),"Pattern")},VariableDeclaration:function(t,e,r){for(var n="var"==t.kind?v(e):e,o=0;o<t.declarations.length;++o){var i=t.declarations[o];r(i.id,N(n,e),"Pattern"),i.init&&r(i.init,e,"Expression")}},ClassDeclaration:function(t,e,r){x(e,t.id),t.superClass&&r(t.superClass,e,"Expression");for(var n=0;n<t.body.body.length;n++)r(t.body.body[n],e)},ForInStatement:function(t,e,r){!t.scope&&S(t.left)&&(e=t.scope=new Nt(e,t,!0)),n.base.ForInStatement(t,e,r)},ForStatement:function(t,e,r){!t.scope&&t.init&&S(t.init)&&(e=t.scope=new Nt(e,t,!0)),n.base.ForStatement(t,e,r)},ImportDeclaration:function(t,e){for(var r=0;r<t.specifiers.length;r++)x(e,t.specifiers[r].local)}});jt.ForOfStatement=jt.ForInStatement;var Ct=t.propName=function(t,e){var r=t.property||t.key;if(!t.computed&&"Identifier"==r.type)return r.name;if("Literal"==r.type){if("string"==typeof r.value)return r.value;if("number"==typeof r.value)return String(r.value)}if(e){var n=O(V(r,e));if(n)return t.propName=n}else if(t.propName)return t.propName;return"<i>"},At=t.inferPatternVisitor={Identifier:function(t,e,r){r.propagate(I(t,e))},MemberExpression:function(t,e,r){var n=V(t.object,e),o=Ct(t,e);n.propagate(new rt(o,r,t.property))},RestElement:function(t,e,r){H(t.argument,e,new bt(r))},ObjectPattern:function(t,e,r){for(var n=0;n<t.properties.length;++n){var o=t.properties[n];H(o.value,e,r.getProp(Ct(o)))}},ArrayPattern:function(t,e,r){for(var n=0;n<t.elements.length;n++)t.elements[n]&&H(t.elements[n],e,r.getProp(String(n)))},AssignmentPattern:function(t,e,r){H(t.left,e,F(r,V(t.right,e)))}},Ft=t.inferExprVisitor={ArrayExpression:L(function(t,e){return _(t.elements,e,V)}),ObjectExpression:L(function(t,e,r){for(var n,o=Tt.protos.Object,i=0;i<t.properties.length;++i){var s=t.properties[i];if("__proto__"==s.key.name)if("Literal"==s.value.type&&null==s.value.value)o=null;else{var p=V(s.value,e),a=p.getObjType();a?o=a:n=p}}var u=t.objType=new vt(o,r);return n&&n.propagate(new ht(u)),u.originNode=t,d(null,n||o,function(){for(var r=0;r<t.properties.length;++r){var n=t.properties[r],o=n.key;if(!l(n.key.name)){var i,s=Ct(n,e);if("<i>"==s||"set"==n.kind)i=K;else{var p=i=u.defProp(s,o);p.initializer=!0,"get"==n.kind&&(i=new ot(u,[],null,p))}V(n.value,e,i,s),"FunctionExpression"==n.value.type&&n.value.scope.fnType.self.addType(u,2)}}}),u}),FunctionExpression:L(function(t,e,r){var o=t.scope,i=o.fnType;return r&&!i.name&&(i.name=r),k(t,o),t.expression?V(t.body,o,o.fnType.retval=new X):n.recursive(t.body,o,null,kt,"Statement"),"ArrowFunctionExpression"==t.type&&D(e).propagate(i.self),b(t,i)||T(i),t.id&&o.getProp(t.id.name).addType(i),i}),ClassExpression:L(R),SequenceExpression:L(function(t,e){for(var r=0,n=t.expressions.length-1;r<n;++r)V(t.expressions[r],e,K);return V(t.expressions[n],e)}),UnaryExpression:L(function(t,e){return V(t.argument,e,K),j(t.operator)}),UpdateExpression:L(function(t,e){return V(t.argument,e,K),Tt.num}),BinaryExpression:L(function(t,e){if("+"==t.operator){var r=V(t.left,e),n=V(t.right,e);if(r.hasType(Tt.str)||n.hasType(Tt.str))return Tt.str;if(r.hasType(Tt.num)&&n.hasType(Tt.num))return Tt.num;var o=new X;return r.propagate(new ft(n,o)),n.propagate(new ft(r,o)),o}return V(t.left,e,K),V(t.right,e,K),C(t.operator)?Tt.bool:Tt.num}),AssignmentExpression:L(function(t,e,r){var n,o;if("MemberExpression"==t.left.type?(o=Ct(t.left,e),r||(r="Identifier"==t.left.object.type?t.left.object.name+"."+o:o)):r||"Identifier"!=t.left.type||(r=t.left.name),t.operator&&"="!=t.operator&&"+="!=t.operator?(V(t.right,e,K),n=Tt.num):n=V(t.right,e,null,r),"MemberExpression"==t.left.type){var i=V(t.left.object,e);if("prototype"==o&&m(e,20),"<i>"==o){var s=t.left.property.name,p=e.props[s],a=p&&p.iteratesOver;if(a){m(e,20);var u="MemberExpression"==t.right.type&&t.right.computed&&t.right.property.name==s;return a.forAllProps(function(t,e,r){r&&"prototype"!=t&&"<i>"!=t&&i.propagate(new rt(t,u?e:K))}),n}}i.propagate(new rt(o,n,t.left.property)),M(i),"FunctionExpression"==t.right.type&&i.propagate(t.right.scope.fnType.self,2)}else H(t.left,e,n);return n}),LogicalExpression:q(function(t,e,r){V(t.left,e,r),V(t.right,e,r)}),ConditionalExpression:q(function(t,e,r){V(t.test,e,K),V(t.consequent,e,r),V(t.alternate,e,r)}),NewExpression:q(function(t,e,r,n){"Identifier"==t.callee.type&&t.callee.name in e.props&&m(e,20);for(var o=0,i=[];o<t.arguments.length;++o)i.push(V(t.arguments[o],e));var s=V(t.callee,e),p=new X;s.propagate(new st(p,n&&/\.prototype$/.test(n))),p.propagate(r,90),s.propagate(new ot(p,i,t.arguments,new ct(r)))}),CallExpression:q(function(t,e,r){for(var n=0,o=[];n<t.arguments.length;++n)o.push(V(t.arguments[n],e));var i=v(e).fnType;if("MemberExpression"==t.callee.type){var s=V(t.callee.object,e),p=Ct(t.callee,e);i&&("call"==p||"apply"==p)&&i.args.indexOf(s)>-1&&m(e,30),s.propagate(new it(p,o,t.arguments,r))}else if("Super"==t.callee.type&&Tt.curSuperCtor)t.callee.superType=Tt.curSuperCtor,Tt.curSuperCtor.propagate(new ot(D(e),o,t.arguments,r)),D(e).propagate(r,90);else{var a=V(t.callee,e);i&&i.args.indexOf(a)>-1&&m(e,30);var u=a.getFunctionType();u&&u.instantiateScore&&i&&m(e,u.instantiateScore/5),a.propagate(new ot(Tt.topScope,o,t.arguments,r))}}),MemberExpression:q(function(t,e,r){var n,o=Ct(t);if("<i>"==o){var i=V(t.property,e),s=O(i);s?o=t.propName=s:i.hasType(Tt.num)||(n=6)}V(t.object,e).getProp(o).propagate(r,n)}),Identifier:L(function(t,e){if("arguments"==t.name){var r=v(e,!1);!r.fnType||t.name in r.props||r.defProp(t.name,r.fnType.originNode).addType(new bt(r.fnType.arguments=new X))}return e.getProp(t.name)}),ThisExpression:L(function(t,e){return D(e)}),Super:L(function(t){return t.superType=Tt.curSuper||K}),Literal:L(function(t){return A(t)}),TemplateLiteral:L(function(t,e){for(var r=0;r<t.expressions.length;++r)V(t.expressions[r],e,K);return Tt.str}),TaggedTemplateExpression:q(function(t,e,r){for(var n=[new bt(Tt.str)],o=0;o<t.quasi.expressions.length;++o)n.push(V(t.quasi.expressions[o],e));V(t.tag,e,new ot(Tt.topScope,n,t.quasi.expressions,r))}),YieldExpression:L(function(t,e){var r=K,n=v(e).fnType;return n&&(n.retval==K&&(n.retval=new X),n.yieldval||(n.yieldval=new X),r=n.retval),t.argument&&(t.delegate?V(t.argument,e,new it("next",[],null,new et("value",r))):V(t.argument,e,r)),n?n.yieldval:K})};Ft.ArrowFunctionExpression=Ft.FunctionExpression;var kt=t.inferWrapper=n.make({Expression:function(t,e){V(t,t.scope||e,K)},FunctionDeclaration:function(t,e,r){var n=t.scope,o=n.fnType;k(t,n),r(t.body,n,"Statement"),b(t,o)||T(o),e.getProp(t.id.name).addType(o)},Statement:function(t,e,r){r(t,t.scope||e)},VariableDeclaration:function(t,e){for(var r=0;r<t.declarations.length;++r){var n=t.declarations[r];if("Identifier"==n.id.type){var o=e.getProp(n.id.name);n.init&&V(n.init,e,o,n.id.name)}else n.init&&H(n.id,e,V(n.init,e))}},ClassDeclaration:function(t,e){e.getProp(t.id.name).addType(R(t,e,t.id.name))},ReturnStatement:function(t,e){if(t.argument){var r=K,n=v(e).fnType;n&&(n.retval==K&&(n.retval=new X),r=n.retval),V(t.argument,e,r)}},ForInStatement:function(t,e,r){var n=V(t.right,e)
;if("Identifier"==t.right.type&&t.right.name in e.props||"MemberExpression"==t.right.type&&"prototype"==t.right.property.name){m(e,5);var o=G(t.left);"Identifier"==o.type?(o.name in e.props&&(e.getProp(o.name).iteratesOver=n),n.getProp("<i>").propagate(I(o,e))):H(o,e,n.getProp("<i>"))}r(t.body,e,"Statement")},ForOfStatement:function(t,e,r){var n,o=G(t.left);"Identifier"==o.type?n=I(o,e):H(o,e,n=new X),V(t.right,e,new it(":Symbol.iterator",[],null,new it("next",[],null,new et("value",n)))),r(t.body,e,"Statement")}}),It=t.parse=function(t,n,o){n&&!Array.isArray(n)||(n=o);var i;try{i=e.parse(t,n)}catch(e){i=r.parse_dammit(t,n)}return i};t.analyze=function(e,r,o){"string"==typeof e&&(e=It(e)),r||(r="file#"+Tt.origins.length),t.addOrigin(Tt.curOrigin=r),o||(o=Tt.topScope),Tt.startAnalysis(),n.recursive(e,o,null,jt),Tt.parent&&Tt.parent.signal("preInfer",e,o),n.recursive(e,o,null,kt),Tt.parent&&Tt.parent.signal("postInfer",e,o),Tt.curOrigin=null},t.purge=function(t,e,r){var n=B(t,e,r);++Tt.purgeGen,Tt.topScope.purge(n);for(var o in Tt.props){for(var i=Tt.props[o],s=0;s<i.length;++s){var p=i[s],a=p.props[o];a&&!n(a,a.originNode)||i.splice(s--,1)}i.length||delete Tt.props[o]}},X.prototype.purge=function(t){if(this.purgeGen!=Tt.purgeGen){this.purgeGen=Tt.purgeGen;for(var e=0;e<this.types.length;++e){var r=this.types[e];t(r,r.originNode)?this.types.splice(e--,1):r.purge(t)}if(this.types.length||(this.maxWeight=0),this.forward)for(var e=0;e<this.forward.length;++e){var n=this.forward[e];t(n)?(this.forward.splice(e--,1),this.props&&(this.props=null)):n.purge&&n.purge(t)}}},K.purge=function(){},vt.prototype.purge=function(t){if(this.purgeGen==Tt.purgeGen)return!0;this.purgeGen=Tt.purgeGen;for(var e in this.props){var r=this.props[e];t(r,r.originNode)&&this.removeProp(e),r.purge(t)}},Pt.prototype.purge=function(t){if(!vt.prototype.purge.call(this,t)){this.self.purge(t),this.retval.purge(t);for(var e=0;e<this.args.length;++e)this.args[e].purge(t)}};var Ht=t.typeFinder={ArrayExpression:function(t,e){return _(t.elements,e,Y)},ObjectExpression:function(t){return t.objType},ClassExpression:function(t){return t.objType},FunctionExpression:function(t){return t.scope.fnType},ArrowFunctionExpression:function(t){return t.scope.fnType},SequenceExpression:function(t,e){return Y(t.expressions[t.expressions.length-1],e)},UnaryExpression:function(t){return j(t.operator)},UpdateExpression:function(){return Tt.num},BinaryExpression:function(t,e){if(C(t.operator))return Tt.bool;if("+"==t.operator){var r=Y(t.left,e),n=Y(t.right,e);if(r.hasType(Tt.str)||n.hasType(Tt.str))return Tt.str}return Tt.num},AssignmentExpression:function(t,e){return Y(t.right,e)},LogicalExpression:function(t,e){var r=Y(t.left,e);return r.isEmpty()?Y(t.right,e):r},ConditionalExpression:function(t,e){var r=Y(t.consequent,e);return r.isEmpty()?Y(t.alternate,e):r},NewExpression:function(t,e){var r=Y(t.callee,e).getFunctionType(),n=r&&r.getProp("prototype").getObjType();return n?pt(n,r):K},CallExpression:function(t,e){return $(t.callee,t.arguments,e)},MemberExpression:function(t,e){var r=Ct(t),n=Y(t.object,e).getType();return n?n.getProp(r):"<i>"==r?K:U(r)},MethodDefinition:function(t){var e=Ct(t),r=D(t.value.scope).getType();return r?r.getProp(e):K},Identifier:function(t,e){return e.hasProp(t.name)||K},ThisExpression:function(t,e){return D(e)},Literal:function(t){return A(t)},Super:L(function(t){return t.superType}),TemplateLiteral:function(){return Tt.str},TaggedTemplateExpression:function(t,e){return $(t.tag,t.quasi.expressions,e)},YieldExpression:function(t,e){var r=v(e).fnType;return r?r.yieldval:K}},Dt=t.searchVisitor=n.make({Function:function(t,e,r){n.base.Function(t,t.scope,r)},CatchClause:function(t,e,r){n.base.CatchClause(t,t.scope,r)},Property:function(t,e,r){t.computed&&r(t.key,e,"Expression"),t.key!=t.value&&r(t.value,e,"Expression")},Statement:function(t,e,r){r(t,t.scope||e)},ImportSpecifier:function(t,e,r){r(t.local,e)},ImportDefaultSpecifier:function(t,e,r){r(t.local,e)},ImportNamespaceSpecifier:function(t,e,r){r(t.local,e)}});t.fullVisitor=n.make({MemberExpression:function(t,e,r){r(t.object,e,"Expression"),r(t.property,e,t.computed?"Expression":null)},Property:function(t,e,r){t.computed&&r(t.key,e,"Expression"),r(t.value,e,"Expression")}},Dt),t.findExpressionAt=function(t,e,r,o,i){var s=i||function(t,e){return("Identifier"!=e.type||"✖"!=e.name)&&Ht.hasOwnProperty(e.type)};return n.findNodeAt(t,e,r,s,Dt,o||Tt.topScope)},t.findExpressionAround=function(t,e,r,o,i){var s=i||function(t,r){return!(null!=e&&r.start>e)&&(("Identifier"!=r.type||"✖"!=r.name)&&Ht.hasOwnProperty(r.type))};return n.findNodeAround(t,r,s,Dt,o||Tt.topScope)},t.expressionType=function(t){return Y(t.node,t.state)},t.parentNode=function(t,e){function r(e,i,s){if(e.start<=t.start&&e.end>=t.end){var p=o[o.length-1];if(e==t)throw{found:p};p!=e&&o.push(e),n.base[s||e.type](e,i,r),p!=e&&o.pop()}}var o=[];try{r(e,null)}catch(t){if(t.found)return t.found;throw t}};var Mt=t.findTypeFromContext={ArrayExpression:function(t,e,r){return r(t,!0).getProp("<i>")},ObjectExpression:function(t,e,r){for(var n=0;n<t.properties.length;++n){var o=e.properties[n];if(o.value==e)return r(t,!0).getProp(Ct(o))}},UnaryExpression:function(t){return j(t.operator)},UpdateExpression:function(){return Tt.num},BinaryExpression:function(t){return C(t.operator)?Tt.bool:Tt.num},AssignmentExpression:function(t,e,r){return r(t.left)},LogicalExpression:function(t,e,r){return r(t,!0)},ConditionalExpression:function(t,e,r){if(t.consequent==e||t.alternate==e)return r(t,!0)},CallExpression:function(t,e,r){for(var n=0;n<t.arguments.length;n++){if(t.arguments[n]==e){var o=r(t.callee).getFunctionType();if(o instanceof Pt)return o.args[n];break}}},ReturnStatement:function(t,e,r){var o=n.findNodeAround(e.sourceFile.ast,e.start-1,"Function");if(o){var i="FunctionDeclaration"!=o.node.type?r(o.node,!0).getFunctionType():o.node.scope.fnType;if(i)return i.retval.getType()}},VariableDeclarator:function(t,e,r){if(t.init==e)return r(t.id)}};Mt.NewExpression=Mt.CallExpression,t.typeFromContext=function(e,r){var n=t.parentNode(r.node,e),o=null;if(Mt.hasOwnProperty(n.type)){var i=Mt[n.type];o=i&&i(n,r.node,function(n,o){var i={node:n,state:r.state};return(o?t.typeFromContext(e,i):t.expressionType(i))||K})}return o||t.expressionType(r)};var Rt=!1;t.resetGuessing=function(t){Rt=t},t.didGuess=function(){return Rt},t.forAllPropertiesOf=function(t,e){t.gatherProperties(e,0)},t.findRefs=function(e,r,o,i,s){function p(t,r,n){if(t.name==o&&(t!=e.id||"FunctionDeclaration"!=e.type))for(var p=r;p;p=p.prev)if(p==i&&s(t,r,n),o in p.props)return}n.ancestor(e,{Identifier:p,VariablePattern:p},t.fullVisitor,r)};var _t=n.make({Function:function(t,e,r){r(t.body,t.scope,t.expression?"Expression":"Statement")},Statement:function(t,e,r){r(t,t.scope||e)}});t.findPropRefs=function(t,e,r,o,i){function s(t){for(;t&&t!=r;){if(t.props[o]||t.maybeProps&&t.maybeProps[o])return!1;t=t.proto}return t}for(;r&&!r.props[o]&&(!r.maybeProps||!r.maybeProps[o]);)r=r.proto;if(!r)throw new Error("Couldn't locate property in the base object type.");n.simple(t,{MemberExpression:function(t,e){t.computed||Ct(t)!=o||s(Y(t.object,e).getType())&&i(t.property,e)},ObjectExpression:function(t,e){if(Y(t,e).getType()==r)for(var n=0;n<t.properties.length;++n)Ct(t.properties[n])==o&&i(t.properties[n].key,e)},MethodDefinition:function(t){Ct(t)==o&&t.value&&s(D(t.value.scope).getType())&&i(t.key,t.value.scope)}},_t,e)};var Lt=t.scopeAt=function(t,e,r){var o=n.findNodeAround(t,e,function(t,e){return e.scope});return o?o.node.scope:r||Tt.topScope};t.forAllLocalsAt=function(t,e,r,n){Lt(t,e,r).gatherProperties(n,0)},o=t.def=o.init({},t)});
